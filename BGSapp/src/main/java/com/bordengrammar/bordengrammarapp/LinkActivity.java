...
public class LinkActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
	    ...
	    if(link=="error"){
		    TextView ty = (TextView)findViewById(R.id.linerror);
		    ty.setVisibility(View.VISIBLE);
		    ty.setText("A error occured");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			case R.id.action_realsettings:
				ut.logIt("settings");
				Intent s = new Intent(LinkActivity.this, SettingsActivity.class);
				startActivity(s);
				return true;
			case R.id.action_privacy:
				Intent ss = new Intent(LinkActivity.this, PrivacyActivity.class);
				startActivity(ss);
				return true;
